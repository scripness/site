This is the Phoenix + Tailwind personal site for Andrei Scripcaru.

## Mission

Deliver a cozy, premium-feeling personal site that makes hiring managers want to spend time exploring the work and that keeps a single canonical resume link.
...
- Always wrap LiveView templates in `<Layouts.app flash={@flash}>...</Layouts.app>`.
